...
class SimpleTestXmlParser
{
     ...
     *    @return XmlParser        Expat handle.
     *    @access protected
     */
    public function _createParser()
    {
        $expat = xml_parser_create();
        xml_set_element_handler($expat, $this->_startElement(...), $this->_endElement(...));
        xml_set_character_data_handler($expat, $this->_addContent(...));
        xml_set_default_handler($expat, $this->_default(...));
        return $expat;
    }
