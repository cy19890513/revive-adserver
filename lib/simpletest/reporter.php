...
class HtmlReporter extends SimpleReporter
{
    ...
    public function paintFooter($test_name)
    {
        ...
        global $start;
        if (!is_null($start)) {
            [$endUsec, $endSec] = explode(" ", microtime());
            $endTime = ((float) $endUsec + (float) $endSec);
            [$startUsec, $startSec] = explode(" ", $start);
...
class SelectiveReporter extends SimpleReporterDecorator
{
     ...
     *    @access protected
     */
    public function _isCaseMatch($test_case)
    {
     ...
     *    @access protected
     */
    public function _isTestMatch($method)
    {
